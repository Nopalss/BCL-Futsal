  ...
  <div class="col-lg-7 ">
    ...
    <div class="card  mt-5 bg-white mb-5 rounded shadow-lg">
      ...
      <?= $this->session->flashdata('message'); ?>
        <form action="<?= base_url('booking/editBooking/').$booking['id'] ?> " method="post">
          ...
          <div class="form-group">
            ...
            <input type="input" id="id_pelanggan" class="form-control" name="id_pelanggan" value="<?= $booking['id_pelanggan']  ?>" readonly>
            <?= form_error('id_pelanggan', '<small class="text-danger pl-3">', '</small>'); ?>
          </div>
          <div class="form-group">
            <label for="nama"><b>Nama</b></label>
            <input type="input" id="nama" class="form-control" name="nama" value="<?= $pelanggan['nama']  ?>">
            <?= form_error('nama', '<small class="text-danger pl-3">', '</small>'); ?>
          </div>
          <div class="form-group">
            <label for="no_telepon"><b>No Telepon</b></label>
            <input type="input" id="no_telepon" class="form-control" name="no_telepon" value="<?= $pelanggan['no_telepon'] ?>">
